...
from . import main
from app.request import get_headlines,get_category,get_source,get_source_articles,search_topic
...
def article(id):
    ...
    return render_template('articles.html',articles= articles,id=id,sources=sources,category=category)   
